...
def parse_map_options(background_map_date_restriction, background_map_location, background_map_file, query_map_file, longitude_column, latitude_column, found_in_background_data, config):

    if 6 in config['report_content']:
        map_functions.parse_background_map_options(background_map_file, background_map_date_restriction, background_map_location, found_in_background_data, config)
