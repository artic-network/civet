...
setup(name='civet',
      ...
      "civet/scripts/input_qc_functions.py",
      "civet/scripts/custom_logger.py",
      "civet/scripts/report_funcs.py",
      ...
      "civet/scripts/time_functions.py",
      "civet/scripts/prep_data.py",
      "civet/scripts/class_definitions.py"],
